...
import my.com.gofutsal.domain.*;
import my.com.gofutsal.repository.*;
import my.com.gofutsal.repository.search.*;
...
public class ElasticsearchIndexService {
    ...
    public ElasticsearchIndexService(
        ...
        BookingStatusSearchRepository bookingStatusSearchRepository,
        CourtRepository courtRepository,
        CourtSearchRepository courtSearchRepository,
        CourtLocationRepository courtLocationRepository,
        CourtLocationSearchRepository courtLocationSearchRepository,
        CourtTypeRepository courtTypeRepository,
        CourtTypeSearchRepository courtTypeSearchRepository,
    ...
    public void reindexAll() {
        if (reindexLock.tryLock()) {
            try {
                ...
                reindexForClass(BookingStatus.class, bookingStatusRepository, bookingStatusSearchRepository);
                reindexForClass(Court.class, courtRepository, courtSearchRepository);
                reindexForClass(CourtLocation.class, courtLocationRepository, courtLocationSearchRepository);
                reindexForClass(CourtType.class, courtTypeRepository, courtTypeSearchRepository);
